...
export default {
  ...
  fields: [
    ...
    // },
    {
      ...
      name: 'cartCalculator',
      type: 'boolean',
      description: 'Display a free shipping calculator in the cart'
    },
    {
      title: 'Free Shipping Value',
      name: 'cartFreeShipping',
      type: 'number',
      description: 'Value needed to trigger free shipping',
      hidden: ({ parent }) => !parent.cartCalculator
    },
    {
      title: 'Cart Message',
      name: 'cartMessage',
